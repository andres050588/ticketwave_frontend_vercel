...
export default function TicketDetailPage() {
    ...
    const handleDeleteTicket = async () => {
        ...
        try {
            ...
            console.error(error.response?.data?.error || "Errore nella cancellazione")
        ...
        <Container className="my-5">
            ...
            <Card>
                <Card.Body>
                    ...
                    {isOwner && ticket.status !== "acquistato" && (
                        <Button variant="danger" className="w-100 mt-2" onClick={handleDeleteTicket}>
                            Cancella Biglietto
                        </Button>
                    )}
