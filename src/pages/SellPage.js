        ...
        <Container style={{ maxWidth: "500px", marginTop: "50px" }}>
            ...
            <Form onSubmit={formik.handleSubmit}>
                ...
                <Form.Group className="mb-4">
                    <Form.Label>
                        Carica Immagine del Biglietto <Upload size={18} className="ms-1" />
                    </Form.Label>

                    <Alert variant="info" className="py-1 px-2">
                        <small>
                            L’immagine del biglietto è <strong>obbligatoria</strong>. Sono ammessi solo file JPG o PNG (max 5MB).
                        </small>
                    </Alert>
